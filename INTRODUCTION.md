...
### 全體回合驅動的人生旅程
遊戲從 **20 歲**開始；所有存活玩家各完成一次行動，就完成一個全體人生回合並增加 **4 歲**。第 19 輪結束來到 96 歲時宣布最後一輪，第 20 輪全員完成後來到 100 歲並結算。

60／90／120 分鐘倒數仍保留給主持人掌控活動節奏，但歸零不會替玩家增加年齡，也不會強制結束遊戲。
...
- **選擇是否繼續進修**：借學貸並用第一個人生回合完成進修，換取 FQ 加成與醫生、律師、IT 工程師等高階職業資格
...
內圈（老鼠賽跑，24 格）
  → 路過「第二人生」格
  → 財務基礎 + 健康／成長／關係／體驗的人生累積
    → 進入外圈（第二人生 FastTrack，17 格）
```

**內圈**不再設個別發薪日格；全體完成 3 個完整回合後依序進行一次統一發薪。格子類型包含：小交易、大交易、意外支出（Doodad）、市場行情、人際關係、危機事件、添丁、裁員、慈善捐款等。

**外圈**進入後優勢顯著：
- 所有被動收入 × **2.0** 倍
- 每次季度統一發薪時，所有資產市值 × **1.06**（+6% 複利增值）
- 每次季度統一發薪額外獲得「資產總市值 × 1%」紅利現金
...
flowchart TD
    ...
    G --> H
    H --> I{通過第二人生綜合資格？}
    I -->|是，且已路過第二人生格| J[進入外圈 FastTrack]
    I -->|尚未| E
    J --> K[外圈複利增值循環]
    K --> L{虛擬年齡到 100 歲？}
    L -->|是| M[全場結算，依幸福總分排名]
