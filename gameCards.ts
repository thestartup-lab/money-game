...
export const BIG_DEALS: DealCard[] = [
  {
    ...
    asset: {
      ...
      cost: 400000,
      downPayment: 75000,
      monthlyCashflow: 1600,
      liabilityName: '商辦房貸',
      liabilityAmount: 325000,
    },
  },
  {
    id: 'bd-002',
  ...
  },
  {
    ...
    asset: {
      ...
      cost: 300000,
      downPayment: 90000,
      monthlyCashflow: 2200,
      liabilityName: '民宿房貸',
      liabilityAmount: 210000,
    },
  },
  {
    id: 'bd-006',
...
export const MARKET_CARDS: MarketCard[] = [
  ...
  },
  {
    id: 'mk-008',
    title: '法拍屋出售機會',
    description: '銀行拍賣一棟優質房產，以固定價格 $120,000 出售。有房地產資產的玩家可選擇出售持有物件。',
    targetAssetType: AssetType.RealEstate,
    effect: 'SellOpportunity',
    fixedPriceOffer: 120000,
  },
];
...
export const CRISIS_EVENTS: CrisisCard[] = [
  // --- 醫療類（需醫療險）---
  {
    id: 'cr-001',
    title: '心臟病突發',
    description: '突發心臟病緊急送醫，手術與住院費用高達 $50,000。無醫療險者現金不足時將觸發死亡判定。',
  ...
  },
  {
    id: 'cr-002',
    title: '重大疾病確診',
    description: '確診需要長期治療的重大疾病，醫療費用 $25,000 且需休養。',
    requiredInsurance: 'hasMedicalInsurance',
    baseCost: 25000,
    insuredCost: 0,
  ...
  },
  {
    id: 'cr-003',
    title: '緊急手術住院',
    description: '意外受傷需緊急手術，手術加住院費 $15,000。有醫療險僅需支付掛號費。',
    requiredInsurance: 'hasMedicalInsurance',
    baseCost: 15000,
    insuredCost: 500,
    turnsLostWithoutInsurance: 1,
  ...
  // --- 財產 / 企業類（需財產險）---
  {
    id: 'cr-004',
    title: '住宅大火',
    description: '家中發生火災，損失慘重。無財產險需自行賠付 $30,000 修繕費用。',
  ...
  },
  {
    id: 'cr-005',
    title: '企業訴訟',
    description: '生意上的糾紛引發法律訴訟，律師費與賠償金共 $20,000。有財產/企業險可全額理賠。',
    requiredInsurance: 'hasPropertyInsurance',
    baseCost: 20000,
    insuredCost: 0,
    turnsLostWithoutInsurance: 0,
  ...
  },
  {
    id: 'cr-006',
    title: '天然災害損失',
    description: '地震造成房屋結構損壞，修繕費用 $40,000。有財產險全額理賠。',
    requiredInsurance: 'hasPropertyInsurance',
    baseCost: 40000,
    insuredCost: 0,
    turnsLostWithoutInsurance: 0,
  ...
  },
  {
    id: 'cr-008',
    title: '罕見疾病長期治療',
    description: '確診罕見疾病，需長期高額治療費用 $45,000。有壽險保障家人。',
    requiredInsurance: 'hasLifeInsurance',
    baseCost: 45000,
    insuredCost: 0,
    turnsLostWithoutInsurance: 2,
...
export const MARRIAGE_CARDS: MarriageCard[] = [
  {
    id: 'marry-001',
    title: '幸福結婚',
    description: '你們攜手步入禮堂！雙薪家庭，每月多了 $800 的生活收入加成。',
    monthlyBonus: 800,
    lifeExpGain: 15,
  },
  {
    id: 'marry-002',
    title: '閃婚',
    description: '認識不久便決定在一起，衝動也是一種勇氣！每月收入加成 $500，但初期有些磨合。',
    monthlyBonus: 500,
    lifeExpGain: 12,
  },
  {
    id: 'marry-003',
    title: '老來得配',
    description: '緣分在 50 歲後到來，相識恨晚！每月收入加成 $600，且健康值互相支持 +10。',
    monthlyBonus: 600,
    lifeExpGain: 18,
  },
];
...
export const RELATIONSHIP_EVENTS: RelationshipCard[] = [
  ...
  },
  {
    id: 'rel-004',
    title: '朋友創業邀請',
    description: '好友邀你共同創業，需先投入 $10,000 作為啟動資金。擲骰 ≥ 4 成功：月被動收入 +$800；失敗：現金 -$10,000。',
    eventCategory: 'opportunity',
    effect: {
      gambleSuccess: {
        threshold: 4,
        successCashflow: 800,
        failureCashLoss: 10000,
      },
    },
  },
  // ── 負面事件（4 張）──
  ...
  },
  {
    id: 'rel-006',
    title: '借錢給朋友血本無歸',
    description: '朋友向你借錢後失聯，這筆錢再也回不來了。現金 -$5,000。',
    eventCategory: 'negative',
    effect: { cashCost: 5000 },
  },
  {
    id: 'rel-007',
    title: '職場霸凌',
  ...
  },
  {
    id: 'rel-008',
    title: '詐騙受害',
    description: '熟識的人以投資名義詐騙你，錢財兩失，人脈信任也大受打擊。現金 -$8,000，NT -1。',
    eventCategory: 'negative',
    effect: { cashCost: 8000, networkDelta: -1 },
  },
  // ── 機遇型事件（4 張）──
  {
    id: 'rel-009',
  ...
  },
  {
    id: 'rel-011',
    title: '慈善募款受邀',
    description: '你被邀請主辦社區慈善活動，付出金錢卻贏得口碑與人脈。現金 -$2,000，NT +2，體驗值 +10。',
    eventCategory: 'opportunity',
    effect: { cashCost: 2000, networkDelta: 2, lifeExpGain: 10 },
  },
  {
    id: 'rel-012',
    title: '家族糾紛調解',
    description: '家族財產糾紛需要你出面協調，費時費力但維繫了家族關係。現金 -$3,000，子女月支出 -$200（家庭關係改善）。',
    eventCategory: 'opportunity',
    effect: { cashCost: 3000, monthlyCashflowDelta: 200 },
  },
];
